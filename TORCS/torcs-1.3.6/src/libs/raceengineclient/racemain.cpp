/***************************************************************************
    ...
    version     : $Id: racemain.cpp,v 1.13.2.10 2014/04/15 09:34:17 berniw Exp $
...
/////////////////////////// by Yurong
		if (ReInfo->_displayMode != RM_DISP_MODE_TRAIN)
/////////////////////////// end by Yurong
	...
	if ((ReInfo->_displayMode != RM_DISP_MODE_CONSOLE) &&  ReInfo->_reGraphicItf.initview != 0) {
		...
		if (ReInfo->_displayMode == RM_DISP_MODE_NORMAL
/////////////////////////// by Yurong
		|| ReInfo->_displayMode == RM_DISP_MODE_TRAIN
/////////////////////////// by Yurong
		) {
...
/////////////////////////// by Yurong
 ...
 //        	exit(EXIT_FAILURE);
 //    	}
 //    	printf("\n********** TORCS: Memory sharing stopped. Good Bye! **********\n");
 //    	exit(EXIT_SUCCESS);
	// }
/////////////////////////// end by Yurong
	return ReDisplayResults();
