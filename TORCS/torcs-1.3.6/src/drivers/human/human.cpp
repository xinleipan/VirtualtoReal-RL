...
///////// drive on the road with 3 lanes
 ...
 //        if (car->_trkPos.toMiddle<=(half_lane_width+1.2) && car->_trkPos.toMiddle>=(half_lane_width-1.2)) { // on the center L marking
 ...
 //        } else if (car->_trkPos.toMiddle<=-(half_lane_width-1.2) && car->_trkPos.toMiddle>=-(half_lane_width+1.2)) { // on the center R marking
 ...
 //           else dist_R=max_dist_range;
 //        } else if (car->_trkPos.toMiddle<=-(lane_width+half_lane_width-1.2) && car->_trkPos.toMiddle>=-(lane_width+half_lane_width+2)) { // on the right marking
 //           toMarking_L=car->_trkPos.toMiddle+half_lane_width;
 ...
 //        } else if (car->_trkPos.toMiddle<=(lane_width+half_lane_width+2) && car->_trkPos.toMiddle>=(lane_width+half_lane_width-1.2)) { // on the left marking
 ...
 //        *pbrakeCmd = car->_brakeCmd;
        	...
        	// NORM_PI_PI(angle);
        	*psteerCmd = car->_steerCmd * car->_steerLock;
